        ...
        <div>
            ...
            <div className="currently-market">
                ...
                <div className='col-lg-1 ms-auto buttonProfile'>
                    ...
                    <Link to='/Portfolio' className='btn  buttonx actives rounded-pill me-2 mb-2' style={{ color: "white", borderColor: "#7453fc" }} ><i className="fa-solid fa-newspaper p-2" /></Link>
